...
def merge_image_4_camera_center_perspective(image_crop, destination_perspective, properties_image, gradient_mode):
    ...
    #                      thickness=-1)
    image_2 = image_crop[1].copy()
    # image_2 = cv2.circle(image_2, tuple(pos_image_2_left_rear), radius=20, color=(0, 255, 0), thickness=-1)
    # image_3 = cv2.circle(image_crop[2].copy(), (pos_image_3_right_front[0] - properties_image[keys[2]]["crop_left"],
    #                                             pos_image_3_right_front[1]), radius=20, color=(0, 255, 0), thickness=-1)
    image_3 = image_crop[2].copy()
    # image_3 = cv2.circle(image_3, (pos_image_3_right_rear[0] - properties_image[keys[2]]["crop_left"],
    #                                pos_image_3_right_rear[1]), radius=20, color=(0, 255, 0), thickness=-1)
    # image_4 = cv2.circle(image_crop[3].copy(), tuple(pos_image_4_rear_left), radius=30, color=(0, 0, 255), thickness=-1)
    image_4 = image_crop[3].copy()
    # image_4 = cv2.circle(image_4, tuple(pos_image_4_rear_right), radius=30, color=(255, 0, 0), thickness=-1)
    ...
    # image_3 process
    shift_3_x = pos_image_1_front_right[0] - pos_image_3_right_front[0] + properties_image[keys[2]]["bird_view"]["crop_left"]
    ...
    if pos_image_1_front_right[0] - pos_image_3_right_front[0] + image_3.shape[1] > image_1.shape[1]:
        end_3_x = pos_image_1_front_right[0] - pos_image_3_right_front[0] + image_3.shape[1] - image_1.shape[1] + \
                  properties_image[keys[2]]["bird_view"]["crop_left"]
    ...
    overlap_front_right, front_right_ov, right_front_ov = find_overlapping_front_right(image_1, image_3,
                                                                                       ...
                                                                                       properties_image[keys[2]]["bird_view"][
                                                                                           "crop_left"])
    ...
    if overlap_rear_right is not None:
        ...
        # print(pos_image_1_front_left)
        bird_view = bird_view[pos_image_1_front_left[1] - 200:shift_4_y + pos_image_4_rear_left[1] + 200,
                    pos_image_1_front_left[0] - 200: pos_image_1_front_right[0] + 200]
